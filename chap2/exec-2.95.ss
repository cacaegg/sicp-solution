...
(define (install-sparse-termlist)
 ...
 (define (remainder-terms dividend divisor)
  (display (list "remainder-terms:" dividend divisor))(newline)
...
(let ((p1 (make-sparse-polynomial 'x '((2 1) (1 -2) (0 1))))
 ...
 (newline)))
; Here, we got to (gcd q2 q1)
; (gcd (polynomial x sparse (4 11) (3 -22) (2 18) (1 -14) (0 7)) (polynomial x sparse (3 13) (2 -21) (1 3) (0 5)))
; First, the (div q2 q2)
; Then we need to the divide first term of q1 and q2 (div (4 11) (3 13))
; > (1 0)
; apply to rest of result will not change anything, leep (div q1 q2)
; Hence, it goes to a loop.

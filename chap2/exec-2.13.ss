...
; Under small percentage, the lower & higher bound is very close.
; The multi-interval will return [la * lb, ua * ub]
; with la ~= ua ~= a ^ lb ~= ub ~= b
; Hence, the result [x, y] ~= [a*b, a*b] 
(let ((a (make-center-percent 3 0.0001)) 
      (b (make-center-percent 5 0.0002)))
 (mul-interval a b))

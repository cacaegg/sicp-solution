...
(let ((p1 (make-sparse-polynomial 'x '((2 1) (1 -2) (0 1))))
      (p2 (make-sparse-polynomial 'x '((2 11) (0 7))))
      (p3 (make-sparse-polynomial 'x '((1 13) (0 5)))))
 (let ((q1 (mul p1 p2))
       (q2 (mul p1 p3)))
 (display (list "gcd-poly:" (greatest-common-divisor q1 q2)))
 (newline)))

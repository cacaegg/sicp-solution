...
(define (install-complex-package)
 ...
 (define (rational->complex r)
  (let ((n ((get 'numer 'rational) (content r)))
        (d ((get 'denom 'rational) (content r))))
 ...
 (put 'project 'complex
      (lambda (obj) ((get-coercion 'complex 'rational) obj)))
 (put 'add-3 '(complex complex complex)
      (lambda (x y z) (tag (add-complex x (add-complex y z)))))
 (put-coercion 'scheme-number 'complex scheme-number->complex)
 (put-coercion 'rational 'complex rational->complex)
 (put-coercion 'complex 'rational
  (lambda (c) ((get 'make 'rational) (real-part c) 1))))
 'done)

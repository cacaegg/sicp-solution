;; From right to left, due to construct-arglist construct in reverse order
;; If we include append as premitive operation, then we can have no difference
;; for left to right or right to left solution 
...
(define (construct-arglist operand-codes)
  (let ((operand-codes-r (reverse operand-codes)))

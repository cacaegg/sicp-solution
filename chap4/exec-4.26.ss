;; If unless is a syntax rather than a procedure, then it can't do higher order procedure
;; (map unless if-conds usual-streams excpetional-streams)
...
(define (analyze exp)
  (cond ((self-evaluating? exp)
        ...
        (else
          (error 'eval "Unknown expression type -- ANALYZE" exp))))
...
(define (unless-expt exp) (cdddr exp))
(define (unless->if exp)
  (make-if (unless-cond exp) (unless-expt exp) (unless-usual exp)))

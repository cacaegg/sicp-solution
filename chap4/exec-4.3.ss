...
(define (eval exp env)
  ...
  (cond ((self-evaluating? exp) exp)
        ...
        ((not (null? (get 'type-op (type-tag exp)))) 
...
(define (eval-definition exp env)
  ; (display (list 'eval-definition exp))(newline)
...
(define (make-procedure exps env)
  (list 'procedure 
        (procedure-parameters exps)
        (list (procedure-body exps))
        env))

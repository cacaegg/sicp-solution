;; a. No, this scan out won't work. It's due to let doesn't have order of evaluation
;;    (let ((a (integral (delay dy) y0 dt))
;;          (b (dy (stream-map f y))))
;;   Then if b is evaluated first, f will be 'unassigneed
;; 
;; b. If scan out in text can run this sample
;;    Due to its' delay evaluation.
;;    That is, a can be define with delayed evaluation of dy
;;    And b can reference a as a bounded variable
